// ─── DCA Engine Contract ABI ─────────────────────────────────────────
// Extracted from compiled Sierra JSON (stark_dca::dca_engine::DCAEngine).
// Used by starknet.service.ts for on-chain interactions.
...
export const dcaEngineAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'usdt_token', type: 'core::starknet::contract_address::ContractAddress' },
      { name: 'mbtc_token', type: 'core::starknet::contract_address::ContractAddress' },
  ...
  },
  {
    ...
    members: [
      ...
      { name: 'amount_per_execution', type: 'core::integer::u256', kind: 'data' },
  ...
  },
  {
    ...
    kind: 'struct',
    members: [
      { name: 'by', type: 'core::starknet::contract_address::ContractAddress', kind: 'data' },
    ],
  },
  {
    type: 'event',
