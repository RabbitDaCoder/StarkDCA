...
// Premium split-panel design with dark mode support.
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-md">
          <div className="glass rounded-2xl overflow-hidden">
            <CardHeader className="text-center pb-4 pt-8 px-8">
              ...
              <div className="flex justify-center mb-4 lg:hidden">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xl font-heading font-bold text-foreground">StarkDCA</span>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-4 pt-2 pb-8 px-8">
              ...
              <p className="text-xs text-muted-foreground text-center">
                ...
                <a href="#" className="text-brand-orange/80 hover:underline">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="#" className="text-brand-orange/80 hover:underline">
